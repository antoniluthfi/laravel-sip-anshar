    ...
    <div class="container mb-4">
        <div class="row">
            <div class="float-left" style="width: 30%;">  
                ...
                <p class="lead-2 ml-1 mt-0 mb-0 p-0">Tanggal Faktur</p>
                <p class="lead-2 ml-1 mt-0 mb-0 p-0">Nomor Faktur</p>
            </div>
            <div class="float-right" style="width: 69%;">
                ...
                <p class="lead-2 ml-1 mt-0 mb-0 p-0">: {{ date_format($data->created_at, "d M Y") }}</p>
                <p class="lead-2 ml-1 mt-0 mb-0 p-0">: {{ $data->no_faktur }}</p>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th class="display-6">Harga</th>
                <th class="display-6">Diskon</th>
                <th class="display-6">Total</th>
            </tr>
        </thead>
        <tbody>
