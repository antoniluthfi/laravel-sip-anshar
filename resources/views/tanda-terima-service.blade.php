...
<body style="font-family: serif;">
    ...
    <div class="float-left ml-1" style="width: 62%;">        
        <h1 class="display-5 mt-0 mb-0 p-0" style="font-weight: bold; letter-spacing: 1.5px;">TWINCOM SERVICE CENTER {{ strtoupper($data->cabang->nama_cabang) }}</h1>
    ...
    <div class="float-right border" style="width: 26%">
        ...
        <div class="clearfix">
            ...
            <div class="float-right" style="width: 56%;">
                ...
                <p class="lead mt-0 mb-0">: {{ $data->customer->name }}</p>
